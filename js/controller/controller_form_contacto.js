'use strict'
// ! form contactenos y update contacto en clientes
...
$(document).ready(function () {
    ...
    //     let cedula = $(this).val();
    //     console.log(cedula + 'adfasdf');
    //     console.log(`hola`);
    //     validaCedulaContactoNac(cedula);
    ...
    txtComentarios.change(function () {
    ...
    // ? Submit form
    $('#form-contactenos').submit(function (event) {
